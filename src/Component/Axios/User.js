...
function User() {
  ...
  return (
   ...
   <button onClick={getData}>Get data</button><hr></hr>
   
   {
    user.length>0 &&(
        ...
        <div>
                ...
                <input type='radio' name='gender' value='all' defaultChecked onChange={filterData}/>
                <input type='radio' name='gender' value='male' onChange={filterData}/>
                <input type='radio' name='gender' value='female' onChange={filterData} />
